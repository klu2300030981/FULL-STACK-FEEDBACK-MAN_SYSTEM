...
function UpdateStudentFaculty() {
    const [studentFaculties, setStudentFaculties] = useState([]);
    ...
    useEffect(() => {
        const fetchStudentFaculties = () => {
            const url = 'http://localhost:2006/student-faculty-feedback'; // Backend endpoint to get all student-faculty mappings
            ...
            callApi(
                ...
                (response) => {
                    ...
                    setStudentFaculties(data); // Update the state with student-faculty data
                },
                (error) => {
        ...
        fetchStudentFaculties();
    }, []);

    // Handle deletion of a student-faculty mapping
    const handleDelete = (id) => {
        const url = `http://localhost:2006/student-faculty-feedback/${id}`;
        ...
        callApi(
            ...
            null,
            (response) => {
                const updatedStudentFaculties = studentFaculties.filter(studentFaculty => studentFaculty.id !== id);
                setStudentFaculties(updatedStudentFaculties);
                alert('Student-Faculty mapping deleted successfully!');
                window.location.href = '/student-faculty-mapping/update';
            },
            (error) => {
                console.error('Error deleting student-faculty mapping:', error);
                setErrorMessage('Failed to delete student-faculty data. Please try again later.');
                alert('Error deleting student-faculty mapping!');
            }
        );
    };
        ...
        <div className="admin-home">
            ...
            <main className="content">
                <div className="view-students-container">
                    <h2>Update Student-Faculty Mapping</h2>
