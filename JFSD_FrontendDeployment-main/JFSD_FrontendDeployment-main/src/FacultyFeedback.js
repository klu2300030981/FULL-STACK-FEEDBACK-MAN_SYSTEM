...
function FacultyFeedback() {
    ...
    const handleSubmit = (id, studentId, facultyId) => {
        ...
        <div className="admin-home">
            ...
            <nav className="navbar">
                <ul>
                    ...
                    <li>
                        <button onClick={() => toggleMenu('institutional-services')}>Institutional Services</button>
            ...
            <main className="content">
                <div className="view-faculty-container">
                    <h2>Provide Faculty Feedback</h2>
                    {errorMessage ? (
                        ...
                        <table className="faculty-table">
                            ...
                            <tbody>
                                {faculties.map((item) => (
                                    <tr key={item.faculty.faculty_Id}>
